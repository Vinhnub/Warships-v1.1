...
lstPathShip = [(resource_path("assets/images/ship2.png"), (FIELD_COORD[0] + 3, FIELD_COORD[1] + 3), 1),
...
pathImages = [resource_path("assets/images/Torpedo_correct.png"),resource_path("assets/images/Torpedo_incorrect.png")]

listWarShips = [resource_path("assets/images/warships_1.png"),
            resource_path("assets/images/warships_2.png"),
            resource_path("assets/images/warships_3.png"),
            resource_path("assets/images/warships_4.png"),
            resource_path("assets/images/warships_5.png"),
            resource_path("assets/images/warships_6.png"),
            resource_path("assets/images/warships_7.png"),
            resource_path("assets/images/warships_8.png"),
            resource_path("assets/images/warships_9.png"),
            resource_path("assets/images/warships_9.png"),
            resource_path("assets/images/warships_9.png"),
            resource_path("assets/images/warships_9.png"),
                ]